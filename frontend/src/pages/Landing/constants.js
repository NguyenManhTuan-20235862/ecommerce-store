export const drops = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=600&h=400&q=80&fit=crop",
  },
  {
...
export const footerLinks = ["Bộ sưu tập", "Câu chuyện", "Cửa hàng", "Liên hệ"];

export const sectionNavItems = [
  { label: "Bộ mới", href: "#drops" },
